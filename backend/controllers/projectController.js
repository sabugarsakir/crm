...
const deleteProject = async (req, res) => {
    try {
        ...
        await leadModel.deleteMany({ project: id });
...
export { createProject, getProject, getProjectInfo, getAllProject, updateProject, getProjectsWithLeadCount, assignSelfToProject, deleteProject };
